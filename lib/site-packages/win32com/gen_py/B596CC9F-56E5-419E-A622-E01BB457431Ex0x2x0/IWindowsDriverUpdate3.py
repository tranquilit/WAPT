...
class IWindowsDriverUpdate3(DispatchBaseClass):
	'IWindowsDriverUpdate3 Interface'
	CLSID = IID('{49EBD502-4A96-41BD-9E3E-4C5057F4250C}')
	coclass_clsid = None
...
win32com.client.CLSIDToClass.RegisterCLSID( "{49EBD502-4A96-41BD-9E3E-4C5057F4250C}", IWindowsDriverUpdate3 )
# -*- coding: utf-8 -*-
# Created by makepy.py version 0.5.01
# By python version 2.7.14 (v2.7.14:84471935ed, Sep 16 2017, 20:19:30) [MSC v.1500 32 bit (Intel)]
# From type library '{B596CC9F-56E5-419E-A622-E01BB457431E}'
...
IWindowsDriverUpdate3_vtables_dispatch_ = 1
IWindowsDriverUpdate3_vtables_ = [
	(( u'BrowseOnly' , u'retval' , ), 1610940417, (1610940417, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 256 , (3, 0, None, None) , 0 , )),
]
