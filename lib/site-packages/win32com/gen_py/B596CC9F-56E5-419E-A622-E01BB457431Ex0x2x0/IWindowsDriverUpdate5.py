...
class IWindowsDriverUpdate5(DispatchBaseClass):
	'IWindowsDriverUpdate5 Interface'
	CLSID = IID('{70CF5C82-8642-42BB-9DBC-0CFD263C6C4F}')
	coclass_clsid = None
	...
	def CopyToCache(self, pFiles=defaultNamedNotOptArg):
		...
		return self._oleobj_.InvokeTypes(1610874882, LCID, 1, (24, 0), ((9, 1),),pFiles
			)

	_prop_map_get_ = {
		"AutoDownload": (1611071490, 2, (3, 0), (), "AutoDownload", None),
		"AutoSelectOnWebSites": (1610743809, 2, (11, 0), (), "AutoSelectOnWebSites", None),
		"AutoSelection": (1611071489, 2, (3, 0), (), "AutoSelection", None),
		"BrowseOnly": (1610940417, 2, (11, 0), (), "BrowseOnly", None),
		...
		"CveIDs": (1610874884, 2, (9, 0), (), "CveIDs", '{EFF90582-2DDC-480F-A06D-60F3FBC362C3}'),
		...
		"DeviceProblemNumber": (1610809351, 2, (3, 0), (), "DeviceProblemNumber", None),
		"DeviceStatus": (1610809352, 2, (3, 0), (), "DeviceStatus", None),
		...
		"DriverClass": (1610809345, 2, (8, 0), (), "DriverClass", None),
		"DriverHardwareID": (1610809346, 2, (8, 0), (), "DriverHardwareID", None),
		"DriverManufacturer": (1610809347, 2, (8, 0), (), "DriverManufacturer", None),
		"DriverModel": (1610809348, 2, (8, 0), (), "DriverModel", None),
		"DriverProvider": (1610809349, 2, (8, 0), (), "DriverProvider", None),
		"DriverVerDate": (1610809350, 2, (7, 0), (), "DriverVerDate", None),
		...
		"IsPresent": (1610874883, 2, (11, 0), (), "IsPresent", None),
		...
		"PerUser": (1611005954, 2, (11, 0), (), "PerUser", None),
		"RebootRequired": (1610874881, 2, (11, 0), (), "RebootRequired", None),
		...
		# Method 'WindowsDriverUpdateEntries' returns object of type 'IWindowsDriverUpdateEntryCollection'
		"WindowsDriverUpdateEntries": (1611005953, 2, (9, 0), (), "WindowsDriverUpdateEntries", '{0D521700-A372-4BEF-828B-3D00C10ADEBD}'),
	}
	_prop_map_put_ = {
...
win32com.client.CLSIDToClass.RegisterCLSID( "{70CF5C82-8642-42BB-9DBC-0CFD263C6C4F}", IWindowsDriverUpdate5 )
# -*- coding: mbcs -*-
# Created by makepy.py version 0.5.01
# By python version 2.7.14 (v2.7.14:84471935ed, Sep 16 2017, 20:19:30) [MSC v.1500 32 bit (Intel)]
# From type library '{B596CC9F-56E5-419E-A622-E01BB457431E}'
...
IWindowsDriverUpdate5_vtables_dispatch_ = 1
IWindowsDriverUpdate5_vtables_ = [
	(( u'AutoSelection' , u'retval' , ), 1611071489, (1611071489, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 268 , (3, 0, None, None) , 0 , )),
	(( u'AutoDownload' , u'retval' , ), 1611071490, (1611071490, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 272 , (3, 0, None, None) , 0 , )),
]
