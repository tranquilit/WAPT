...
class IUpdate2(DispatchBaseClass):
	'IUpdate2 Interface'
	CLSID = IID('{144FE9B0-D23D-4A8B-8634-FB4457533B7A}')
	coclass_clsid = None
...
win32com.client.CLSIDToClass.RegisterCLSID( "{144FE9B0-D23D-4A8B-8634-FB4457533B7A}", IUpdate2 )
# -*- coding: utf-8 -*-
# Created by makepy.py version 0.5.01
# By python version 2.7.14 (v2.7.14:84471935ed, Sep 16 2017, 20:19:30) [MSC v.1500 32 bit (Intel)]
# From type library '{B596CC9F-56E5-419E-A622-E01BB457431E}'
...
IUpdate2_vtables_dispatch_ = 1
IUpdate2_vtables_ = [
	(( u'RebootRequired' , u'retval' , ), 1610809345, (1610809345, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 208 , (3, 0, None, None) , 0 , )),
	(( u'IsPresent' , u'retval' , ), 1610809347, (1610809347, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 212 , (3, 0, None, None) , 0 , )),
	(( u'CveIDs' , u'retval' , ), 1610809348, (1610809348, (), [ (16393, 10, None, "IID('{EFF90582-2DDC-480F-A06D-60F3FBC362C3}')") , ], 1 , 2 , 4 , 0 , 216 , (3, 0, None, None) , 0 , )),
	(( u'CopyToCache' , u'pFiles' , ), 1610809346, (1610809346, (), [ (9, 1, None, "IID('{EFF90582-2DDC-480F-A06D-60F3FBC362C3}')") , ], 1 , 1 , 4 , 0 , 220 , (3, 0, None, None) , 0 , )),
]
