...
class IUpdate3(DispatchBaseClass):
	'IUpdate3 Interface'
	CLSID = IID('{112EDA6B-95B3-476F-9D90-AEE82C6B8181}')
	coclass_clsid = None
...
win32com.client.CLSIDToClass.RegisterCLSID( "{112EDA6B-95B3-476F-9D90-AEE82C6B8181}", IUpdate3 )
# -*- coding: utf-8 -*-
# Created by makepy.py version 0.5.01
# By python version 2.7.14 (v2.7.14:84471935ed, Sep 16 2017, 20:19:30) [MSC v.1500 32 bit (Intel)]
# From type library '{B596CC9F-56E5-419E-A622-E01BB457431E}'
...
IUpdate3_vtables_dispatch_ = 1
IUpdate3_vtables_ = [
	(( u'BrowseOnly' , u'retval' , ), 1610874881, (1610874881, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 224 , (3, 0, None, None) , 0 , )),
]
