...
class IStringCollection(DispatchBaseClass):
	...
	CLSID = IID('{EFF90582-2DDC-480F-A06D-60F3FBC362C3}')
	coclass_clsid = IID('{72C97D74-7C3B-40AE-B77D-ABDB22EBA6FB}')

	def Add(self, value=defaultNamedNotOptArg):
		'Adds an item to the collection.'
		return self._oleobj_.InvokeTypes(1610743811, LCID, 1, (3, 0), ((8, 1),),value
			)
	...
	def Copy(self):
		...
		if ret is not None:
			ret = Dispatch(ret, u'Copy', '{EFF90582-2DDC-480F-A06D-60F3FBC362C3}')
		return ret

	def Insert(self, index=defaultNamedNotOptArg, value=defaultNamedNotOptArg):
		'Inserts an item to the collection at the specified position.'
		return self._oleobj_.InvokeTypes(1610743814, LCID, 1, (24, 0), ((3, 1), (8, 1)),index
			, value)
...
win32com.client.CLSIDToClass.RegisterCLSID( "{EFF90582-2DDC-480F-A06D-60F3FBC362C3}", IStringCollection )
# -*- coding: mbcs -*-
# Created by makepy.py version 0.5.01
# By python version 2.7.14 (v2.7.14:84471935ed, Sep 16 2017, 20:19:30) [MSC v.1500 32 bit (Intel)]
# From type library '{B596CC9F-56E5-419E-A622-E01BB457431E}'
...
IStringCollection_vtables_ = [
	...
	(( u'Add' , u'value' , u'retval' , ), 1610743811, (1610743811, (), [ (8, 1, None, None) , 
			(16387, 10, None, None) , ], 1 , 1 , 4 , 0 , 48 , (3, 0, None, None) , 0 , )),
	(( u'Clear' , ), 1610743812, (1610743812, (), [ ], 1 , 1 , 4 , 0 , 52 , (3, 0, None, None) , 0 , )),
	(( u'Copy' , u'retval' , ), 1610743813, (1610743813, (), [ (16393, 10, None, "IID('{EFF90582-2DDC-480F-A06D-60F3FBC362C3}')") , ], 1 , 1 , 4 , 0 , 56 , (3, 0, None, None) , 0 , )),
