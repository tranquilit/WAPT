...
class IUpdateSession2(DispatchBaseClass):
	'IUpdateSession2 Interface'
	CLSID = IID('{91CAF7B0-EB23-49ED-9937-C52D817F46F7}')
	coclass_clsid = None
...
win32com.client.CLSIDToClass.RegisterCLSID( "{91CAF7B0-EB23-49ED-9937-C52D817F46F7}", IUpdateSession2 )
# -*- coding: mbcs -*-
# Created by makepy.py version 0.5.01
# By python version 2.7.14 (v2.7.14:84471935ed, Sep 16 2017, 20:19:30) [MSC v.1500 32 bit (Intel)]
# From type library '{B596CC9F-56E5-419E-A622-E01BB457431E}'
...
IUpdateSession2_vtables_dispatch_ = 1
IUpdateSession2_vtables_ = [
	(( u'UserLocale' , u'retval' , ), 1610809345, (1610809345, (), [ (16403, 10, None, None) , ], 1 , 2 , 4 , 0 , 60 , (3, 0, None, None) , 0 , )),
	(( u'UserLocale' , u'retval' , ), 1610809345, (1610809345, (), [ (19, 1, None, None) , ], 1 , 4 , 4 , 0 , 64 , (3, 0, None, None) , 0 , )),
]
