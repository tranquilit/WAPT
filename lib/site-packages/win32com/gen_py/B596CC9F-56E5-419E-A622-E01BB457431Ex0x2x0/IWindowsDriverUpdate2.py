...
class IWindowsDriverUpdate2(DispatchBaseClass):
	'IWindowsDriverUpdate2 Interface'
	CLSID = IID('{615C4269-7A48-43BD-96B7-BF6CA27D6C3E}')
	coclass_clsid = None
...
win32com.client.CLSIDToClass.RegisterCLSID( "{615C4269-7A48-43BD-96B7-BF6CA27D6C3E}", IWindowsDriverUpdate2 )
# -*- coding: utf-8 -*-
# Created by makepy.py version 0.5.01
# By python version 2.7.14 (v2.7.14:84471935ed, Sep 16 2017, 20:19:30) [MSC v.1500 32 bit (Intel)]
# From type library '{B596CC9F-56E5-419E-A622-E01BB457431E}'
...
IWindowsDriverUpdate2_vtables_dispatch_ = 1
IWindowsDriverUpdate2_vtables_ = [
	(( u'RebootRequired' , u'retval' , ), 1610874881, (1610874881, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 240 , (3, 0, None, None) , 0 , )),
	(( u'IsPresent' , u'retval' , ), 1610874883, (1610874883, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 244 , (3, 0, None, None) , 0 , )),
	(( u'CveIDs' , u'retval' , ), 1610874884, (1610874884, (), [ (16393, 10, None, "IID('{EFF90582-2DDC-480F-A06D-60F3FBC362C3}')") , ], 1 , 2 , 4 , 0 , 248 , (3, 0, None, None) , 0 , )),
	(( u'CopyToCache' , u'pFiles' , ), 1610874882, (1610874882, (), [ (9, 1, None, "IID('{EFF90582-2DDC-480F-A06D-60F3FBC362C3}')") , ], 1 , 1 , 4 , 0 , 252 , (3, 0, None, None) , 0 , )),
]
