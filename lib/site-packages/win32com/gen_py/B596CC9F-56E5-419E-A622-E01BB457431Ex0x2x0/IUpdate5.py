...
class IUpdate5(DispatchBaseClass):
	'IUpdate5 Interface'
	CLSID = IID('{C1C2F21A-D2F4-4902-B5C6-8A081C19A890}')
	coclass_clsid = None
	...
	_prop_map_get_ = {
		"AutoDownload": (1611005954, 2, (3, 0), (), "AutoDownload", None),
		"AutoSelectOnWebSites": (1610743809, 2, (11, 0), (), "AutoSelectOnWebSites", None),
		"AutoSelection": (1611005953, 2, (3, 0), (), "AutoSelection", None),
...
win32com.client.CLSIDToClass.RegisterCLSID( "{C1C2F21A-D2F4-4902-B5C6-8A081C19A890}", IUpdate5 )
# -*- coding: utf-8 -*-
# Created by makepy.py version 0.5.01
# By python version 2.7.14 (v2.7.14:84471935ed, Sep 16 2017, 20:19:30) [MSC v.1500 32 bit (Intel)]
# From type library '{B596CC9F-56E5-419E-A622-E01BB457431E}'
...
IUpdate5_vtables_dispatch_ = 1
IUpdate5_vtables_ = [
	(( u'AutoSelection' , u'retval' , ), 1611005953, (1611005953, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 232 , (3, 0, None, None) , 0 , )),
	(( u'AutoDownload' , u'retval' , ), 1611005954, (1611005954, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 236 , (3, 0, None, None) , 0 , )),
]
