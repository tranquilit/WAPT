...
class IWindowsDriverUpdate4(DispatchBaseClass):
	'IWindowsDriverUpdate4 Interface'
	CLSID = IID('{004C6A2B-0C19-4C69-9F5C-A269B2560DB9}')
	coclass_clsid = None
...
win32com.client.CLSIDToClass.RegisterCLSID( "{004C6A2B-0C19-4C69-9F5C-A269B2560DB9}", IWindowsDriverUpdate4 )
# -*- coding: utf-8 -*-
# Created by makepy.py version 0.5.01
# By python version 2.7.14 (v2.7.14:84471935ed, Sep 16 2017, 20:19:30) [MSC v.1500 32 bit (Intel)]
# From type library '{B596CC9F-56E5-419E-A622-E01BB457431E}'
...
IWindowsDriverUpdate4_vtables_dispatch_ = 1
IWindowsDriverUpdate4_vtables_ = [
	(( u'WindowsDriverUpdateEntries' , u'retval' , ), 1611005953, (1611005953, (), [ (16393, 10, None, "IID('{0D521700-A372-4BEF-828B-3D00C10ADEBD}')") , ], 1 , 2 , 4 , 0 , 260 , (3, 0, None, None) , 0 , )),
	(( u'PerUser' , u'retval' , ), 1611005954, (1611005954, (), [ (16395, 10, None, None) , ], 1 , 2 , 4 , 0 , 264 , (3, 0, None, None) , 0 , )),
]
