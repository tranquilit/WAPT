...
win32com.client.CLSIDToClass.RegisterCLSID( "{918EFD1E-B5D8-4C90-8540-AEB9BDC56F9D}", IUpdateSession3 )
# -*- coding: utf-8 -*-
# Created by makepy.py version 0.5.01
# By python version 2.7.14 (v2.7.14:84471935ed, Sep 16 2017, 20:19:30) [MSC v.1500 32 bit (Intel)]
# From type library '{B596CC9F-56E5-419E-A622-E01BB457431E}'
...
IUpdateSession3_vtables_dispatch_ = 1
IUpdateSession3_vtables_ = [
	(( u'CreateUpdateServiceManager' , u'retval' , ), 1610874881, (1610874881, (), [ (16393, 10, None, "IID('{0BB8531D-7E8D-424F-986C-A0B8F60A3E7B}')") , ], 1 , 1 , 4 , 0 , 68 , (3, 0, None, None) , 0 , )),
	(( u'QueryHistory' , u'criteria' , u'startIndex' , u'Count' , u'retval' , 
			), 1610874882, (1610874882, (), [ (8, 1, None, None) , (3, 1, None, None) , (3, 1, None, None) , (16393, 10, None, "IID('{A7F04F3C-A290-435B-AADF-A116C3357A5C}')") , ], 1 , 1 , 4 , 0 , 72 , (3, 0, None, None) , 0 , )),
]
