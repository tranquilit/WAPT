...
class IWindowsDriverUpdate(DispatchBaseClass):
	'IWindowsDriverUpdate Interface'
	CLSID = IID('{B383CD1A-5CE9-4504-9F63-764B1236F191}')
	coclass_clsid = None
...
win32com.client.CLSIDToClass.RegisterCLSID( "{B383CD1A-5CE9-4504-9F63-764B1236F191}", IWindowsDriverUpdate )
# -*- coding: utf-8 -*-
# Created by makepy.py version 0.5.01
# By python version 2.7.14 (v2.7.14:84471935ed, Sep 16 2017, 20:19:30) [MSC v.1500 32 bit (Intel)]
# From type library '{B596CC9F-56E5-419E-A622-E01BB457431E}'
...
IWindowsDriverUpdate_vtables_dispatch_ = 1
IWindowsDriverUpdate_vtables_ = [
	(( u'DriverClass' , u'retval' , ), 1610809345, (1610809345, (), [ (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 208 , (3, 0, None, None) , 0 , )),
	(( u'DriverHardwareID' , u'retval' , ), 1610809346, (1610809346, (), [ (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 212 , (3, 0, None, None) , 0 , )),
	(( u'DriverManufacturer' , u'retval' , ), 1610809347, (1610809347, (), [ (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 216 , (3, 0, None, None) , 0 , )),
	(( u'DriverModel' , u'retval' , ), 1610809348, (1610809348, (), [ (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 220 , (3, 0, None, None) , 0 , )),
	(( u'DriverProvider' , u'retval' , ), 1610809349, (1610809349, (), [ (16392, 10, None, None) , ], 1 , 2 , 4 , 0 , 224 , (3, 0, None, None) , 0 , )),
	(( u'DriverVerDate' , u'retval' , ), 1610809350, (1610809350, (), [ (16391, 10, None, None) , ], 1 , 2 , 4 , 0 , 228 , (3, 0, None, None) , 0 , )),
	(( u'DeviceProblemNumber' , u'retval' , ), 1610809351, (1610809351, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 232 , (3, 0, None, None) , 0 , )),
	(( u'DeviceStatus' , u'retval' , ), 1610809352, (1610809352, (), [ (16387, 10, None, None) , ], 1 , 2 , 4 , 0 , 236 , (3, 0, None, None) , 0 , )),
]
