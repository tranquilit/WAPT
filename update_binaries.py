...
pgsql_zip = wget('https://get.enterprisedb.com/postgresql/postgresql-9.4.15-1-windows-x64-binaries.zip',resume=True,md5='cdd7c1bfd656430283899417acf4d82f',cache_dir=binaries_cache,proxies=proxies)
...
innosetup_install = wget('http://www.jrsoftware.org/download.php/is-unicode.exe',resume=True,md5='42b9c2fcfdd96b79aeef49029ce776d4',cache_dir=binaries_cache,proxies=proxies)
...
ssl_zip = wget('https://indy.fulgan.com/SSL/openssl-1.0.2l-i386-win32.zip',resume=True,md5='f1901d936f73d57a9efcef9b028e1621',cache_dir=binaries_cache,proxies=proxies)
