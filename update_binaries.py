...
innosetup_install = wget('http://www.jrsoftware.org/download.php/is-unicode.exe',resume=True,md5='085bf7e3d027152fd9d9eb15172472f4',cache_dir=binaries_cache,proxies=proxies)
