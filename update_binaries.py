...
# innosetup_install = wget('http://www.jrsoftware.org/download.php/is-unicode.exe',resume=True,md5='c55dc9735db9125427a52d0f347b6502',cache_dir=binaries_cache,proxies=proxies)
