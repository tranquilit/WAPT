...
rsync_option = " --exclude 'waptserver/DEBIAN' --exclude 'waptserver/createdeb.sh' --exclude 'waptserver/createdeb.py' --exclude '.svn/**' --exclude '*.exe' --exclude '*.dll' --exclude 'waptserver/builddir/' -ap"
