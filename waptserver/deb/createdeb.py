...
if len(sys.argv) >= 2:
    try:
        ...
        print( "wrong parameter `%s' (should be a positive integer)" % (sys.argv[1],),file=sys.stderr)
        sys.exit(1)
...
try:
    ...
    print('Could not retrieve the hash of the current git commit.',file=sys.stderr)
