...
Debian:
yum install uwsgi uwsgi-plugin-python2


mkdir /var/sockets/
chown wapt:nginx /var/sockets/
...
chdir=/opt/wapt
max-requests=1000
socket=/var/sockets/waptserver.sock
uid=wapt
gid=nginx
plugins=python
chmod-socket = 664
...
upstream waptserver {
   server unix:///var/sockets/waptserver.sock;
}
...
ExecStart=/usr/sbin/uwsgi --ini /opt/wapt/conf/waptserver.ini
