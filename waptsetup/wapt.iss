...
fr.LaunchIcon=Lancer l'ic�ne de notification lors de l'ouverture de session
fr.InstallVCpp=Installer les redistribuables VC++ 2008 (pour openssl)
fr.ForceVCppReinstall=Forcer la r�installation des redistribuables VC++ 2008 (pour openssl)
fr.UpdatePkgUponShutdown=Proposer la mise � jour des paquets � l'extinction du poste
fr.LaunchSession=Lancer WAPT session setup � l'ouverture de session
...
de.LaunchIcon=Benachrichtigungssymbol bei Sitzungser�ffnung  starten
de.InstallVCpp=VC++ 2008 die Redistributables (f�r openssl) installieren
de.ForceVCppReinstall=Force- VC++ 2008 redistributables (f�r openssl) deinstallieren
de.UpdatePkgUponShutdown=Bitten, die Packete beim herunterfahren zu aktualisieren
de.LaunchSession=WAPT setup Sitzung bei er�ffnung der Sitzung starten
