...
type
  ...
  TVisWaptGUI = class(TForm)
    ...
    procedure GridReportingResultChange(Sender: TBaseVirtualTree; Node: PVirtualNode);
    procedure GridReportingResultColumnResize(Sender: TVTHeader; Column: TColumnIndex );
