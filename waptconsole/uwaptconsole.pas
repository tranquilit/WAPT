...
begin
  ...
  begin
    if MessageDlg('Confirmer l''import', format('Etes vous sûr de vouloir importer'#13#10'%s'#13#10' dans votre dépôt ?', [OpenDialogWapt.Files.Text]),
...
begin
  ...
  try
    ...
    DMPython.WAPT.load_config();
    DMPython.WAPT.use_hostpackages := True;
