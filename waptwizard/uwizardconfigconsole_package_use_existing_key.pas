...
type
  ...
  { TWizardConfigConsole_PackageUseExistingKey }

  TWizardConfigConsole_PackageUseExistingKey = class(TWizardStepFrame)
...
procedure TWizardConfigConsole_PackageUseExistingKey.cb_show_passwordChange( Sender: TObject);
var
  c: Char;
begin
...
procedure TWizardConfigConsole_PackageUseExistingKey.ed_certificateAcceptFileName(Sender: TObject; var Value: String);
begin
...
procedure TWizardConfigConsole_PackageUseExistingKey.ed_keyAcceptFileName( Sender: TObject; var Value: String );
var
  crt : String;
  r : integer;
begin
...
constructor TWizardConfigConsole_PackageUseExistingKey.Create(AOwner: TComponent );
begin
  inherited Create( AOwner, PAGE_PACKAGE_USE_EXISTING_KEY );
end;

procedure TWizardConfigConsole_PackageUseExistingKey.clear();
begin
  inherited clear();
...
procedure TWizardConfigConsole_PackageUseExistingKey.wizard_load(w: TWizard);
var
  r   : integer;
  s   : String;
  ini : TIniFile;
...
procedure TWizardConfigConsole_PackageUseExistingKey.wizard_show();
begin
...
procedure TWizardConfigConsole_PackageUseExistingKey.wizard_next( var bCanNext: boolean);
var
...
initialization
  RegisterClass(TWizardConfigConsole_PackageUseExistingKey);
end.
