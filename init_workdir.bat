...
waptpython -c "from waptutils import wget; from subprocess import check_output; pywin32=wget('https://github.com/mhammond/pywin32/releases/download/b223/pywin32-223.win32-py2.7.exe',resume=True,cache_dir= os.path.join('..','binaries_cache'),md5='366d181c39169d3b0c0e1d25f781d1d6'); print check_output('Scripts\easy_install.exe ""%%s""' %% pywin32,shell=True)"
