...
resourcestring
  ...
  rs_package_prefix_must_be_alphanum = 'Package prefix must be alphanum';
  ...
  rs_create_key_a_certificat_this_key_name_exist = 'A certificate with this key name already exists, change key name and click next again';
  rs_supplied_passwords_differs = 'Supplied passwords differs';
  ...
  rs_key_filename_cannot_be_empty = 'Key filename can not be empty';
  ...
  rs_no_matching_key = 'No private key has been found in certificate directory using this password';
  ...
  rs_other_process_has_been_found = 'An instance of %s has been found.'+ #13#10 + 'The program cannot continue until this process has terminated.' + #13#10 + #13#10  + 'Click on Yes to kill all the process named %s' + #13#10 + 'Click on Retry to recheck processes status' + #13#10 +  'Click on Cancel to abort';
